...
Random.getRandomElementFromArray = function(array) {
  var index = Random.getRandomIntExclusive(0, array.length);
  return array[index];
};
...
function Npc(id, board) {
  ...
  this.actionResolvers = [
    __WEBPACK_IMPORTED_MODULE_1__npc_action_resolvers__["a" /* default */].singleCellMove,
...
NpcActionResolvers.kamikazeAttack = function(possibleActions) {
  ...
  var attackResult = __WEBPACK_IMPORTED_MODULE_0__attack__["a" /* default */].simulateRiskAttack(attackingPopulation, target.population);
